...
/// <summary>
/// Defines an Axis in a Tripartite chart.
/// </summary>
public interface ITripartiteAxis : IPlane, INotifyPropertyChanged
{
    /// <summary>
    ...
    /// The orientation.
    /// </value>
    TripartiteAxisOrientation Orientation { get; }
    ...
    void Initialize(TripartiteAxisOrientation orientation);

    /// <summary>
    /// Occurs when the axis is initialized.
    /// </summary>
    event Action<ITripartiteAxis>? Initialized;
...
public interface ITripartiteAxis<TDrawingContext> : ITripartiteAxis
